...
export default function WhatDo(props) {
    return (
        <div className={`card rounded-2xl justify-center items-center  flex dark:border-[1px] ${props.data.color} dark:border-gray-600 dark:bg-black xl:max-w-[370px] min-h-[220px]`}>
